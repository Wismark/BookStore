...
namespace UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Create_Categories()
        {
            ...
            NavController targer = new NavController(mock.Object);

            //Действие (act)
            List<string> result = ((IEnumerable<string>)targer.Menu().Model).ToList();
        ...
        public void Indicates_Selected_Genre()
        {
            ...
            //Действие (act)
            string result = targer.Menu(genreToSelect).ViewBag.SelectedGenre;
